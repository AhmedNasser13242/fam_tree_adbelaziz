    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        <div class="navbar-nav align-items-center">
            <div class="nav-item d-flex align-items-center">
                <input hidden type="text" class="border-0 shadow-none form-control" placeholder="Search..."
                    aria-label="Search..." />
            </div>
        </div>
        <ul class="flex-row navbar-nav align-items-center ms-auto">
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div hidden class="avatar avatar-online">
                        <img src="../assets/img/avatars/1.png" alt class="h-auto w-px-40 rounded-circle" />
                    </div>
                </a>
                <ul hidden class="dropdown-menu dropdown-menu-end">
                    <li>
...
<?php /**PATH C:\MAMP\htdocs\family tree\resources\views/layouts/partials/header.blade.php ENDPATH**/ ?>