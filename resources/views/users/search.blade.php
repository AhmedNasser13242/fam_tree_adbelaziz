...
<h2 class="page-header">
    ...
    @if (request('q'))
    <small class="pull-right">{!! trans('app.user_found', ['total' => $users->total(), 'keyword' => request('q')])
        !!}</small>
    @endif
</h2>
...
<div class="input-group">
    ...
    trans('app.search_your_family_placeholder')]) }}
    ...
    <div class="col-md-3">
        <div class="panel panel-default">
            ...
            <div class="panel-footer">
                ...
                btn-xs']) }}
                {{ link_to_route('users.chart', trans('app.show_family_chart'), [$user->id], ['class' => 'btn
                btn-default btn-xs']) }}
            </div>
        </div>
    </div>
